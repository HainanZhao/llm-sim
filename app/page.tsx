...
const INFERENCE_MODELS: Record<string, {name: string, params: number}> = {
  ...
  'llama-4-mav': { name: 'Llama 4 Maverick', params: 400 },
  'deepseek-v3': { name: 'DeepSeek-V3 (671B)', params: 671 },
